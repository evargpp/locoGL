...
Models::BasicModel szyna("00_szyna.obj");
Models::BasicModel podklad("00_podklad.obj");
Models::BasicModel podtorze("00_podtorze.obj");
//Models::BasicModel podtorze("grzyb.obj");

Models::BasicModel kolo2("01_os_2.obj");
Models::BasicModel kolo3("01_os_2.obj");
Models::BasicModel kolo4("01_os_2.obj");
Models::BasicModel kolo5("01_os_2.obj");
...
void drawScene(GLFWwindow* window,float angle_x,float angle_y,float cam_x,float cam_y,float cam_z) {
	...
	kolo2.Translate(2800.0f, 1200.0f, 0.0f);
	kolo2.drawSolid();

	kolo3.Clear();
	kolo3.RotateX(angle_x);
	kolo3.RotateY(angle_y);
	kolo3.Translate(4800.0f, 1200.0f, 0.0f);
	kolo3.drawSolid();

	kolo4.Clear();
	kolo4.RotateX(angle_x);
	kolo4.RotateY(angle_y);
	kolo4.Translate(6800.0f, 1200.0f, 0.0f);
	kolo4.drawSolid();

	kolo5.Clear();
	kolo5.RotateX(angle_x);
	kolo5.RotateY(angle_y);
	kolo5.Translate(8800.0f, 1200.0f, 0.0f);
	kolo5.drawSolid();
